...
// }
// #[zbus::interface(name = "is.centroid.Slot")]
...
//     let last_value: Arc<Mutex<Option<i64>>> = Arc::new(Mutex::new(None));
//     let greeter: SlotInterface<i64> = SlotInterface { last_value };
